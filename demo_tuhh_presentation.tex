...
% You can change the titlepage layout and the slide icon displayed in the upper left using \institutebranded{PATH_TO_WORDMARK}{PATH_TO_ICON}
%\institutebranded{.theme_imgs/institute_logo_placeholder.pdf}{.theme_imgs/institute_logo_placeholder.pdf}
